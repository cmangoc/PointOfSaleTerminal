    ...
    public class Product
    {
        ...
        public static void OrderProduct()
        {
            ...
            if (input1 >= 1 && input1 <= ProductsList.Count)
            {
                ...
                if (input2 >= 1)
                {
                    ...
                    {
                        if (ShoppingCart[i].Name == ProductsList[input1].Name)
                        {
                            total += ShoppingCart[i].Quantity;
                            ShoppingCart.Remove(ShoppingCart[i]);
                        }
                    }
                    ShoppingCart.Add(new Product(ProductsList[input1].Name, ProductsList[input1].Category, ProductsList[input1].Description, ProductsList[input1].Price * total, total));
        ...
        public static void PayReceipt(decimal total)
        {
            ...
            else if (input == "credit")
            {
                ...
                DisplayReceipt();
                Console.WriteLine(String.Format("{0,84}", $"Card Used: {creditCard}"));
                Console.WriteLine(String.Format("{0,84}", $"Amount Change: ${change}"));
            }
            else if (input == "check")
            {
